...
{
 "use strict";
 var Global,WebSharper,IntroJS,Sample,Client,UI,Next,Var,Operators,Ref,List,T,ListModel,Arrays,WebSharper$IntroJS$Sample_Templates,Snap,Abbrev,Fresh,SC$1,JavaScript,Pervasives,Doc,Int32,Collections,Dictionary,Unchecked,DomUtility,SC$2,View,Docs,JSModule,Seq,Client$1,DocNode,SC$3,Mailbox,Storage,SC$4,Attrs,CheckedInput,DocElemNode,AttrModule,AttrProxy,Slice,Strings,Array,Elt,Enumerator,Docs$1,RunState,NodeSet,An,Async,ArrayStorage,HashSet,DictionaryUtil,Attrs$1,Dyn,String,Concurrency,Anims,AppendList,T$1,Char,N,DynamicAttrNode,SC$5,SC$6,HashSet$1,Scheduler,SC$7,Easing,DomNodes,OperationCanceledException,CancellationTokenSource,HashSetUtil,SC$8,Lazy,IntelliFactory,Runtime;
 Global=window;
 ...
 WebSharper$IntroJS$Sample_Templates=Global.WebSharper$IntroJS$Sample_Templates=Global.WebSharper$IntroJS$Sample_Templates||{};
 Snap=Next.Snap=Next.Snap||{};
 Abbrev=Next.Abbrev=Next.Abbrev||{};
 Fresh=Abbrev.Fresh=Abbrev.Fresh||{};
 SC$1=Global.StartupCode$WebSharper_IntroJS_Sample$Client=Global.StartupCode$WebSharper_IntroJS_Sample$Client||{};
 ...
 {
  var newName,a,t,t$1,t$2,t$3,L,v,f,f$1;
  newName=Var.Create$1("");
  a=WebSharper$IntroJS$Sample_Templates.main((t=(t$1=(t$2=(t$3=T.Empty,(L=(v=Client.People().v,Doc.Convert(function(name)
  {
   var t$4;
   return WebSharper$IntroJS$Sample_Templates.listitem((t$4=T.Empty,new T({
    $:1,
    $0:{
     $:1,
     $0:"name",
   ...
   $0:{
    ...
    $1:(f=function()
    {
     Client.People().Append(newName.c);
     Var.Set(newName,"");
    },function()
    {
     return function()
 ...
 ListModel=Next.ListModel=Runtime.Class({
  ...
  ObsoleteKey:function(key)
  {
   ...
   m[0]?(sn=m[1],Snap.MarkObsolete(sn),v=this.it.Remove(key)):void 0;
  },
  GetEnumerator:function()
  {
 ...
 WebSharper$IntroJS$Sample_Templates.listitem=function(h)
 {
 ...
 WebSharper$IntroJS$Sample_Templates.main=function(h)
 {
  Doc.LoadLocalTemplates("index");
  return h?Doc.NamedTemplate("index",{
   $:1,
 ...
 Doc.ChildrenTemplate=function(el,fillWith)
 {
  ...
  addAttr=function(el$1,attr)
  {
   ...
   v=updates$1.push(Attrs.Updates(attr$1));
   v$1=attrs.push([el$1,attr$1]);
   a=function(f)
   {
    var v$2;
   ...
   return function(o)
   {
    if(o==null)
     ...
     a(o.$0);
   }(Runtime.GetOptional(attr$1.OnAfterRender));
  };
